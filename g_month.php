...
<div id="non-printable">
  ...
  $query = "SELECT COUNT(fileupload) AS totol, DATE_FORMAT(dateup, '%M') AS dateup
  FROM uploadfile
...
<div id="printable">
  ...
  <h1><center>สรุปรายงานการดำเนินงานรายเดือน</center></h1>
...
<center>  <p><h5>พี่อี๊ดปริ้นเตอร์</h5>
  ...
  var myChart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              label: 'รายงานภาพรวม แยกตามรายเดือน (ไฟล์)',
              data: [<?php echo $totol;?>
              ],
              backgroundColor: [
                  'rgba(255, 99, 132, 0.2)',
