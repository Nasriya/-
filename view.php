...
<br></br>
	<h1 class="w3-myfont w3-center">จัดการคิว</h1>
		 ...
		 ";
			...
			<td bgcolor='#61b4cf'><br>fileID</br></td>
			...
			while($row = mysqli_fetch_array($result)) {
				...
				echo "<tr>";
			  echo "<td align='center'  bgcolor='#def1f9'>" .$row["fileID"] .  "</td> ";
				echo "<td align='center'  bgcolor='#e1dedc'> <a href='fileupload/'>" .$row["fileupload"] .  "</td> ";
			  echo "<td align='center'  bgcolor='#def1f9'>" .$row["Quanitity"] .  "</td> ";
...
<?<td align="left"><a href="fileupload/<?=$row["FilesName"]?>" target="_blank"><?php echo $row["FilesName"];?> pop</a></td>?>
